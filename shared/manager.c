...
static void resolve_paths(void) {
    ...
    if (in_sub && path_exists("../shared/generator") && access("../shared/generator", X_OK) == 0) strcpy(GENERATOR_BIN, "../shared/generator");
    else if (path_exists("./shared/generator") && access("./shared/generator", X_OK) == 0) strcpy(GENERATOR_BIN, "./shared/generator");
    else strcpy(GENERATOR_BIN, "./generator");
}
